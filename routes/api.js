...
router.get("/I/want/title", (req, res, next) => {
  ...
  var address = 'http://localhost:3000/I/want/title?address=gfoogle.com&address=www.google.com&address=dawn.com'
  //parse address using the urls module
  var address = url.parse(address, true)
  //web_urls will now get urls e.g. [gfoogle.com, www.google.com, dawn.com] in this case
